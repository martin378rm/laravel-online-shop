                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            <input type="password"
                                                placeholder="Password" id="password" type="password" class="form-control form-control-user @error('password') is-invalid @enderror" name="password" required>
                                        </div>
                                        {{-- <div class="form-group">
