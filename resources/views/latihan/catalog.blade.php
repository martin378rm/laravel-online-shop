        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="order/create">Order</a>
                        <a class="collapse-item" href="register.html">Manajemen Product</a>
                        <a class="collapse-item" href="forgot-password.html">Manajemen Order</a>
                        <div class="collapse-divider"></div>
                        <a class="collapse-item" href="404.html">Forgot Password</a>
                        <a class="collapse-item active" href="blank.html">Catalog</a>
                    </div>
                </div>
            </li>
